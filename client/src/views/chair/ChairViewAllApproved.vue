            ...
            <div class="p-6 flex flex-col md:flex-row justify-between md:items-center">
              <div class="flex-1">
                ...
                <div class="flex items-center gap-2 mt-1">
                  <span
                    class="inline-block bg-green-100 text-green-700 border border-green-200 text-xs font-semibold rounded-full px-2 py-0.5"
                  >
                    Approved
                  </span>

                  <span
                    v-if="paper.final_pdf_path"
                    class="inline-block bg-blue-100 text-blue-700 border border-blue-200 text-xs font-semibold rounded-full px-2 py-0.5"
                  >
                    Final Copy Submitted
                  </span>
                  <span
                    v-else
                    class="inline-block bg-yellow-100 text-yellow-700 border border-yellow-200 text-xs font-semibold rounded-full px-2 py-0.5"
                  >
                    Awaiting Final Copy
                  </span>
                </div>
              ...
              <div class="mt-4 md:mt-0">
                ...
                <a
                  ...
                  target="_blank"
                  class="inline-flex items-center gap-2 bg-gray-400 text-white px-4 py-2 rounded-md text-sm hover:bg-gray-500 transition"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-4 w-4"
